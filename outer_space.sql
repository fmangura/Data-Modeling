...
(
  ...
  celestial_star_id INTEGER NOT NULL REFERENCES celestial_star,
  galaxy TEXT NOT NULL,
  moons TEXT[]
);

INSERT INTO celestial_star
  (star)
VALUES
  ('The Sun'),
  ('Prxima Centauri'),
...
INSERT INTO planets
  (name, orbital_period_in_years, celestial_star_id, galaxy, moons)
VALUES
